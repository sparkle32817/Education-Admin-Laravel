  ...
  <div class="col-lg-4 col-xlg-3 col-md-5">
    ...
    <div class="card">
      <div class="card-body">
        ...
        <hr>
        <div class="row text-center m-t-10">
          <div class="col-md-12"><strong>Service Area</strong>
    ...
    <div class="card">
      ...
      <ul class="nav nav-tabs profile-tab" role="tablist">
        ...
        <div class="pt-2 px-5 flex-xl-grow-1">
          <a href="/tutor" class="btn waves-effect waves-light btn-rounded btn-outline-info m-1 float-right">Back</a>
      </ul>
      <!-- Tab panes -->
          ...
          <div class="card-body">
            <form class="form-horizontal form-material">
              ...
              <div class="form-group">
                ...
                <div class="col-md-12">
                  <input type="text" class="form-control form-control-line" value="{{ $data->qualification }}" disabled>
                </div>
              </div>
              <div class="form-group">
                <label class="col-md-12">Certification</label>
                <div class="col-md-12">
                  <input type="text" class="form-control form-control-line" value="{{ $data->certification }}" disabled>
                </div>
              </div>
              <div class="form-group row">
                <div class="col-md-6">
                  <label class="col-md-12">Hourly Rate (HKD)</label>
                  <div class="col-md-12">
                    <input type="text" class="form-control form-control-line" value="{{ $data->hourly_rate }}" disabled>
                  </div>
                </div>
                <div class="col-md-6">
                  <label class="col-md-12">Experience (Year)</label>
                  <div class="col-md-12">
                    <input type="text" class="form-control form-control-line" value="{{ $data->experience }}" disabled>
                  </div>
                </div>
              </div>
              <div class="form-group">
                    ...
                    <div class="form-group row">
                      ...
                      <div class="col-md-9">
                        <select class="form-control" id="membership" disabled>
                          ...
                          <option value="1" <?= $data->membership_type == 1 ? 'selected' : '' ?>>Plus</option>
                          <option value="2" <?= $data->membership_type == 2 ? 'selected' : '' ?>>Premium</option>
                        </select>
                      </div>
                    </div>
                  </div>
...
<script src="/js/tutor-detail.js"></script>
@endsection